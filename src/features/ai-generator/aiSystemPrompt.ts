...
## 輸出格式
你可以先寫出思考與分析的過程（包含對計分規則的理解），最終必須在 \`\`\`json 區塊中輸出完整的計分板 JSON。頂層結構：
\`\`\`json
{
  "name": "遊戲名稱",
  "columns": [ ... ]
...
## Output Format
Please write out your thinking and analysis process first (including your understanding of the scoring rules), and ultimately you must output the complete scoreboard JSON within a \`\`\`json block. Top-level structure:
\`\`\`json
{
  "name": "Game Name",
  "columns": [ ... ]
