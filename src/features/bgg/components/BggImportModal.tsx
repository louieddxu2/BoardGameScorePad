                        ...
                        <div className="p-6 space-y-6 modal-body">
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                <div className="flex flex-col gap-1">
                                    ...
                                    <div className="mt-2 pl-1 flex items-center flex-wrap gap-x-1.5 text-[11px] text-txt-secondary border-t border-surface-border/40 pt-2">
                                        ...
                                        >
                                            <svg viewBox="0 0 342 76" className="h-5 w-auto shrink-0 text-txt-primary transition-colors" aria-label="BGG Logo">
