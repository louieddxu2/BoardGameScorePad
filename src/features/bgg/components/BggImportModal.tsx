            ...
            >
                {importState === 'importing' || importState === 'analyzing' ? (
                    ...
                    <>
                        ...
                        <div className="p-4 modal-bg-recessed/50 border-t border-surface-border flex flex-col items-center gap-2 flex-none">
                            <a 
                            ...
                            >
                                <svg viewBox="0 0 342 76" className="h-5 w-auto shrink-0 text-txt-primary/80 transition-colors" aria-label="BGG Logo">
                                    <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                        <g transform="translate(0.654300, 0.296900)">
                                            {/* Brand Text: using currentColor to automatically adapt to dark/light modes */}
                                            ...
                                            {/* Orange Geekhead Logo: Remains strictly brand orange */}
                                ...
                                <span className="text-[10px] font-bold text-txt-primary/80 tracking-wide transition-colors">Powered by BoardGameGeek</span>
                            </a>
