...
const InputPanelLayout: React.FC<InputPanelLayoutProps> = ({
  ...
  if (isCompact) {
    return (
      <div className="grid grid-cols-4 grid-rows-[1fr_48px] gap-2 p-2 select-none bg-[rgb(var(--c-input-bg))] h-full min-h-0">
  ...
  // Full Mode: 4x4 Grid
  return (
    <div className="grid grid-cols-4 grid-rows-4 gap-2 p-2 select-none bg-[rgb(var(--c-input-bg))] h-full min-h-0">
