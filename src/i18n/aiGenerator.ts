...
export const aiGeneratorTranslations = {
    'zh-TW': {
        ...
        error_local_rate_limit: "AI 生成使用較頻繁，請約 1 小時後再試。",
        error_generic: "辨識失敗，請確認網路連線或照片清晰度後重試。",
        error_safety_blocked: "這次圖片無法完成分析。請改用清楚的桌遊規則或計分頁照片再試。",
    ...
    'en': {
        ...
        error_local_rate_limit: "AI generation has been used frequently. Please try again in about 1 hour.",
        error_generic: "Analysis failed, please check photo clarity and retry.",
        error_safety_blocked: "This image could not be analyzed. Please retry with clear board game rules or scoring pages.",
