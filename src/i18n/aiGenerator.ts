...
export const aiGeneratorTranslations = {
    'zh-TW': {
        ...
        simple_desc: "拍攝桌遊規則書上的記分說明或計分表，AI 將自動為您生成最適合的計分板。",
        tab_simple: "一般",
        tab_advanced: "進階",
        label_flash_version: "⚡ 極速版",
        label_gemma_version: "🏆 大師版",
    ...
    'en': {
        ...
        simple_desc: "Take a photo of the scoring page in the rulebook, and AI will automatically generate the most suitable scoreboard.",
        tab_simple: "Simple",
        tab_advanced: "Advanced",
        label_flash_version: "⚡ Flash",
        label_gemma_version: "🏆 Master",
