...
export const aiGeneratorTranslations = {
    'zh-TW': {
        ...
        processing_keep_awake_hint: "請保持此畫面開啟，避免鎖定螢幕、切換 App 或離開視窗，以免中斷 AI 分析。",
    ...
    'en': {
        ...
        processing_keep_awake_hint: "Keep this screen open. Avoid locking the screen, switching apps, or leaving this window to prevent interrupting AI analysis.",
