...
export const cloudLibraryTranslations = {
    'zh-TW': {
        ...
        lib_delete_confirm_title: "⚠️ 國防級確認永久刪除",
        lib_btn_delete: "永久刪除",
        lib_btn_cancel: "取消",
        lib_admin_reauth: "憑證已過期，正在重新驗證管理員身份...",
    ...
    'en': {
        ...
        lib_delete_confirm_title: "⚠️ Permanent Delete Confirmation",
        lib_btn_delete: "Delete",
        lib_btn_cancel: "Cancel",
        lib_admin_reauth: "Session expired, re-authenticating admin identity...",
