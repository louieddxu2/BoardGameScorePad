...
export const sessionTranslations = {
  'zh-TW': {
    ...
    multiplayer_exit_requires_disconnect: "請先點上方連線按鈕，選擇「離開房間」後再退出計分板。",
  ...
  'en': {
    ...
    multiplayer_exit_requires_disconnect: "Use the connection button above and choose \"Leave multiplayer room\" before exiting the score sheet.",
