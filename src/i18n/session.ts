...
export const sessionTranslations = {
  'zh-TW': {
    ...
    multiplayer_room_title: "邀請玩家填分",
    multiplayer_room_desc: "請其他玩家掃描 QR Code，下載目前的計分板後選擇要填寫的玩家。",
    multiplayer_connected_count: "已連線 {count} 台裝置",
    multiplayer_waiting: "等待其他玩家加入",
    multiplayer_publish_pending: "計分板有尚未發布的更新",
    multiplayer_publish_update: "發布計分板更新",
    multiplayer_publish_publishing: "發布中",
    multiplayer_publish_published: "已發布",
  ...
  'en': {
    ...
    multiplayer_room_title: "Invite players to score",
    multiplayer_room_desc: "Have other players scan this QR code. They will download this score sheet, then choose the players they score for.",
    multiplayer_connected_count: "{count} connected device(s)",
    multiplayer_waiting: "Waiting for players to join",
    multiplayer_publish_pending: "This score sheet has unpublished updates.",
    multiplayer_publish_update: "Publish score sheet update",
    multiplayer_publish_publishing: "Publishing...",
    multiplayer_publish_published: "Published",
