...
export const sessionTranslations = {
  'zh-TW': {
    ...
    session_ai_waiting_status: "AI 正在生成計分板中...",
    session_ai_waiting_timer: "正在分析圖片並萃取欄位，已耗時 {seconds} 秒...",
    session_ai_generating_with_timer: "🔮 AI 正在生成計分板中... ({seconds}秒)",
  ...
  'en': {
    ...
    session_ai_waiting_status: "AI is generating scoreboard...",
    session_ai_waiting_timer: "Analyzing images and extracting columns, elapsed {seconds}s...",
    session_ai_generating_with_timer: "🔮 AI is generating scoreboard... ({seconds}s)",
