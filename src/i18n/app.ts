...
export const appTranslations = {
  'zh-TW': {
    ...
    app_toast_multiplayer_join_timeout: "無法連線至計分板，請重新掃描 QR Code",
    app_toast_multiplayer_room_ended: "此計分房間已結束",
    app_toast_multiplayer_host_disconnected: "Host 已斷線，連線已中斷",
    app_toast_multiplayer_ownership_returned: "計分板已交回本機控制",
    app_toast_multiplayer_exit_requires_disconnect: "請先點上方連線按鈕，先結束多人房間後再退出計分板。",
    app_toast_multiplayer_moved_to_new_tab: "多人連線已移至新開啟的頁面，本頁已斷線並返回首頁。",
  ...
  'en': {
    ...
    app_toast_multiplayer_join_timeout: "Could not connect to the score sheet. Please scan the QR code again.",
    app_toast_multiplayer_room_ended: "This scoring room has ended.",
    app_toast_multiplayer_host_disconnected: "Host disconnected, connection lost",
    app_toast_multiplayer_ownership_returned: "This score sheet is now under local control.",
    app_toast_multiplayer_exit_requires_disconnect: "Use the connection button above to end the multiplayer room before exiting the score sheet.",
    app_toast_multiplayer_moved_to_new_tab: "The multiplayer connection moved to the newly opened page. This page disconnected and returned to the dashboard.",
