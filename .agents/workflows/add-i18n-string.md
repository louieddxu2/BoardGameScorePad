...
## 步驟零：從 docs/i18n-todo.md 選定目標

> **每次 i18n 任務開始前必讀**，避免重複掃描浪費 token。

1. 打開 [`docs/i18n-todo.md`](../../docs/i18n-todo.md)
2. 選擇優先順序最高的 🔲 項目
3. 確認「對應字典」欄位（步驟一就能跳過）

任務結束時，將該列狀態改為 ✅ 並更新「已完成」區塊。

---

## 步驟一：確認屬於哪個字典模組（若 i18n-todo.md 已標明則可跳過）
