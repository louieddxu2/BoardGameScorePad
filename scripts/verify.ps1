...
Write-Host ""
Write-Host "[2/4] Scanning for hardcoded colors (HEX/RGB)..." -ForegroundColor White
try {
    powershell -ExecutionPolicy Bypass -File "$PSScriptRoot\scan-hardcoded-colors.ps1"
